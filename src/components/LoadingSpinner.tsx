...
+      <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-6 sm:p-12 text-center">
...
+            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{t('upload.processing')}</h3>
+            <p className="text-gray-600 text-sm sm:text-base">Our AI is working hard to provide you with the best insights</p>
           </div>
